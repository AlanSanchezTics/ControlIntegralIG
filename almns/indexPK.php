...
<head>
    ...
    <title>Control Integral Indira Gandhi | Pre kinder</title>
            ...
            <div class="right_col hero" role="main">
                <div class="page-title">
                    <div class="title_left">
                        <h3>Pre kinder Indira Gandhi</h3>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <div class="table-responsive">
                                    <table id="tblpre" class="table table-hover table-striped">
                                        <thead>
                                            <tr>

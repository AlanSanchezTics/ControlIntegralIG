...
<head>
    ...
    <title>Control Integral Indira Gandhi | Primaria</title>
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li class="active"><a><i class="fas fa-user-graduate"></i>Alumnos <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: block;">
                                        ...
                                        <li class="active"><a>Primaria</a></li>
                            ...
                            <div class="x_content">
                                <div class="table-responsive" role="tabpanel" data-example-id="togglable-tabs">
                                    <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                        ...
                                        <li role="presentation" class=""><a href="#tab_content4A" role="tab" id="4A-tab"
                                                data-toggle="tab" aria-expanded="false">4°A</a>
                                        </li>
                                        <li role="presentation" class=""><a href="#tab_content4B" role="tab" id="4B-tab"
                                                data-toggle="tab" aria-expanded="false">4°B</a>
                                        </li>
                                        <li role="presentation" class=""><a href="#tab_content5A" role="tab" id="5A-tab"
                                                data-toggle="tab" aria-expanded="false">5°A</a>
                                        </li>
                                        <li role="presentation" class=""><a href="#tab_content5B" role="tab" id="5B-tab"
                                                data-toggle="tab" aria-expanded="false">5°B</a>
                                        </li>
                                        <li role="presentation" class=""><a href="#tab_content6A" role="tab" id="6A-tab"
                                                data-toggle="tab" aria-expanded="false">6°A</a>
                                        </li>
                                        <li role="presentation" class=""><a href="#tab_content6B" role="tab" id="6B-tab"
                                                data-toggle="tab" aria-expanded="false">6°B</a>
                                        </li>
                                    </ul>
                                    <div id="myTabContent" class="tab-content">
                                        ...
                                        <div role="tabpanel" class="tab-pane fade" id="tab_content4A" aria-labelledby="profile-tab">
                                            <div class="table-responsive">
                                                <table id="tblgpo4a" class="table table-hover table-striped">
                                                    <thead>
                                                        <tr>
                                                            <th colspan="10"><span class="esp"></span><br>
                                                                <span class="ing"></span></th>
                                        ...
                                        <div role="tabpanel" class="tab-pane fade" id="tab_content4B" aria-labelledby="profile-tab">
                                            <div class="table-responsive">
                                                <table id="tblgpo4b" class="table table-hover table-striped">
                                                    <thead>
                                                        <tr>
                                                            <th colspan="10"><span class="esp"></span><br>
                                                                <span class="ing"></span></th>
                                        ...
                                        <div role="tabpanel" class="tab-pane fade" id="tab_content5A" aria-labelledby="profile-tab">
                                            <div class="table-responsive">
                                                <table id="tblgpo5a" class="table table-hover table-striped">
                                                    <thead>
                                                        <tr>
                                                            <th colspan="10"><span class="esp"></span><br>
                                                                <span class="ing"></span></th>
                                        ...
                                        <div role="tabpanel" class="tab-pane fade" id="tab_content5B" aria-labelledby="profile-tab">
                                            <div class="table-responsive">
                                                <table id="tblgpo5b" class="table table-hover table-striped">
                                                    <thead>
                                                        <tr>
                                                            <th colspan="10"><span class="esp"></span><br>
                                                                <span class="ing"></span></th>
                                        ...
                                        <div role="tabpanel" class="tab-pane fade" id="tab_content6A" aria-labelledby="profile-tab">
                                            <div class="table-responsive">
                                                <table id="tblgpo6a" class="table table-hover table-striped">
                                                    <thead>
                                                        <tr>
                                                            <th colspan="10"><span class="esp"></span><br>
                                                                <span class="ing"></span></th>
                                        ...
                                        <div role="tabpanel" class="tab-pane fade" id="tab_content6B" aria-labelledby="profile-tab">
                                            <div class="table-responsive">
                                                <table id="tblgpo6b" class="table table-hover table-striped">
                                                    <thead>
                                                        <tr>
                                                            <th colspan="10"><span class="esp"></span><br>
                                                                <span class="ing"></span></th>

...
var getDocs = function (gpo, gdo, labeling, labelesp) {
    ...
    $.ajax({
        type: "POST",
        url: "process.php",
        data: { "gpo": gpo, "gdo": gdo, "opcion": "GETDOCS", "nivel":1 },
        success: function (response) {
            var data = JSON.parse(response);

...
<body class="nav-md">
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li class="active"><a><i class="fas fa-book-open"></i>Tareas</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="x_panel">
                            <div class="x_title">
                                ...
                                <ul class="nav navbar-right panel_toolbox" style="min-width: 0px;">
                                    <li><a id="addTarea" data-toggle="tooltip" data-placement="top" title="" data-original-title="Publicar Tarea">
                                            <span class="fas fa-book-medical" aria-hidden="true" style="color:green;"></span>
                                        </a></li>
    ...
    <div class="modal fade" id="modal-form" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <form id="tareas-form" class="form-horizontal form-label-left input_mask">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="modal-title">Datos de la Tarea</h4>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                <label for="destinatario">La tarea va dirigida a</label>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                ...
                                <input type="text" class="form-control" id="titulo" name="titulo" placeholder="Titulo de la tarea" required>
        ...
        <div class="modal-dialog" role="document">
            <form id="form-delete">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <input type="hidden" id="idtareaToDelete" name="idTarea">

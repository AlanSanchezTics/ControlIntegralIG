...
<head>
  ...
  <title>Control Integral Indira Gandhi | Administradores</title>
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                ...
                <li class="active"><a><i class="fas fa-user-friends"></i>Administradores</a>
                </li>
      ...
      <div class="right_col hero" role="main">
        <div class="page-title">
          <div class="title_left">
            <h3>Panel de Administradores</h3>
          </div>
        </div>
        <div class="row">
            ...
            <div class="x_panel">
              <div class="x_title">
                ...
                <ul class="nav navbar-right panel_toolbox" style="min-width: 0px;">
                  <li><a id="addAdmin" data-toggle="tooltip" data-placement="top" title="" data-original-title="Agregar Administrador">
        ...
        <form id="admin-form" class="form-horizontal form-label-left input_mask">
            <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title" id="modal-title">Datos del Administrador</h4>
                </div>
      ...
      <div class="modal-dialog" role="document">
          <form id="form-delete">
              <div class="modal-content">
                  ...
                  <div class="modal-body">
                      <input type="hidden" id="idadminTodelete" name="idadmin">
